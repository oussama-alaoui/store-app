                        ...
                        <View key={index} style={{flexDirection: "row", width: "90%", marginBottom: 30}}>
                            <View style={{ width: "80%", justifyContent: "center", borderRadius: 100, }}>
                                ...
                                <Rating
                                    ...
                                    iconHeight={24}
                                />
                                <Text   style={{borderRadius: 10, elevation: 2, borderColor: 'gray', borderWidth: 5, paddingRight: 15, textAlign: 'right', writingDirection: 'rtl',padding: 14, lineHeight: 25, color: '#8D8D8D', fontFamily: 'Bold', fontSize: 13}} >{review.details}</Text>
                            </View>
