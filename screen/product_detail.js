    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.body}>
                <View style={{ width: "90%", height: 136, alignItems: "center", justifyContent: "center", borderRadius: 22, borderWidth: 3, borderColor: '#CAC7C7'}}>
                    <Image
                ...
                <Text style={{ fontFamily: "Bold", fontSize: 16, color: '#616161', marginTop: 10}}>+966 12 345 6789</Text>
            ...
            <ScrollView style={{flex:1, width: "100%", height: "auto",top: '7%', alignItem: 'center', marginBottom: 100}} scrollEnabled={true}>
